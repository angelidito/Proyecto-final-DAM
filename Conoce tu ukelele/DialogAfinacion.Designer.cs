namespace Conoce_tu_ukelele.Forms
{
	partial class DialogAfinacion
	{
		...
		private void InitializeComponent()
		{
			...
			this.txt1.MouseClick += new System.Windows.Forms.MouseEventHandler(this.Txt_TextChanged);
			this.txt1.Leave += new System.EventHandler(this.Txt_TextChanged);
			// 
			// txt2
			// 
			...
			this.txt2.MouseClick += new System.Windows.Forms.MouseEventHandler(this.Txt_TextChanged);
			this.txt2.Leave += new System.EventHandler(this.Txt_TextChanged);
			// 
			// txt3
			// 
			...
			this.txt3.MouseClick += new System.Windows.Forms.MouseEventHandler(this.Txt_TextChanged);
			this.txt3.Leave += new System.EventHandler(this.Txt_TextChanged);
			// 
			// txt4
			// 
			...
			this.txt4.MouseClick += new System.Windows.Forms.MouseEventHandler(this.Txt_TextChanged);
			this.txt4.Leave += new System.EventHandler(this.Txt_TextChanged);
			// 
			// label5
			// 
			...
			this.label5.Text = "Nueva afinación:";
			// 
			// btnAceptar
			// 
